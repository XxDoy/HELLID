...
*/
.webix_view{font-family:Tahoma;font-size:15px;color:#555;cursor:default;overflow:hidden;border:0 solid transparent;background-color:#f4f4f4;white-space:normal;-webkit-appearance:none}
...
.webix_pager_item,.webix_pager_item_selected{padding:0 6px;text-align:center;height:100%;width:32px;border:1px solid transparent;margin:0 2px;cursor:pointer;background-color:#fff;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;font-family:Tahoma;font-size:15px}
...
.webix_modal_box{overflow:hidden;display:inline-block;min-width:250px;width:250px;text-align:center;position:fixed;background-color:#fff;box-shadow:0 3px 6px #c8c8c8;font-family:Tahoma;z-index:20000;border-radius:0}
...
.webix_popup_button.confirm div{font-size:15px;font-family:Tahoma;border:1px solid #bcbcbc;background:#e42750;border-bottom:1px solid #ce1a41;box-shadow:none;color:#fff!important;text-shadow:none!important;border-color:#e42750!important}
...
.webix_popup_text{margin:0 0 5px;padding-top:25px;font-size:15px;color:#555;min-height:60px}
.webix_error,.webix_info{font-size:15px;color:#555;box-shadow:0 0 10px #888;padding:0;background-color:#FFF;border-radius:3px;border:1px solid #fff}
...
.webix_drag_zone{position:absolute;box-shadow:1px 1px 5px transparent;background-color:#fff;font-family:Tahoma;font-size:15px;color:#555}
...
.webix_ss_vscroll_footer{position:absolute;bottom:0;right:0;border-left:1px solid #d6d6d6;border-top:1px solid transparent;z-index:1}
...
.webix_ss_footer TD,.webix_ss_vscroll_footer{background:#fff}
...
.webix_column>div.webix_row_select{border-bottom:1px solid #db1b45;padding-top:0}
...
.webix_dd_drag>div{display:inline-block;vertical-align:top;background:#fff;border-top:1px solid transparent;border-right:1px solid transparent;border-bottom:1px solid transparent;padding:5px 10px;height:32px;line-height:24px;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}
...
.webix_dtable_colrow{position:absolute;left:0;top:0;background-color:#fff;width:100%;padding-right:28px;padding-left:10px;padding-top:1px;border-bottom:1px solid transparent}
...
.webix_tree_img{background:0 0;float:left;width:18px;height:24px}
...
.webix_cal_day,.webix_cal_week_num{cursor:pointer;font-size:12px;color:#555}
...
.webix_cal_day_disabled{color:#bbb;background:#f4f4f4!important}
...
.webix_time_header .webix_cal_hours,.webix_time_header .webix_cal_minutes{display:inline-block;font-size:14px;text-align:center;height:26px;line-height:22px;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;box-shadow:0 1px 1px #FFF inset;border-bottom:1px solid transparent}
...
.webix_property_col_ind{float:right;border:1px solid transparent;border-radius:2px;width:30px;cursor:pointer;height:13px;margin:3px 10px 3px 0}
.webix_property_value{text-overflow:ellipsis;white-space:nowrap}
.webix_property_check{margin-top:5px}
.webix_tooltip{display:none;position:absolute;z-index:10000;background-color:#fff;padding:5px 10px;border:1px solid transparent;font-family:Tahoma;font-size:15px;color:#555;border-radius:3px;box-shadow:1px 1px 0 0 #CCC}
...
input.webixtype_prev{border-left-width:0;border-radius:0;-webkit-border-radius:0;-moz-border-radius-topleft:0;-moz-border-radius-bottomleft:0;-moz-border-radius-topright:0;-moz-border-radius-bottomright:0}
input.webixtype_next{border-right-width:0;border-radius:0;-webkit-border-radius:0;-moz-border-radius-topleft:0;-moz-border-radius-bottomleft:0;-moz-border-radius-topright:0;-moz-border-radius-bottomright:0}
...
.webix_disabled_box .webix_el_arrow,.webix_disabled_box .webixtype_base,.webix_disabled_box .webixtype_danger,.webix_disabled_box .webixtype_form,.webix_disabled_box .webixtype_next,.webix_disabled_box .webixtype_prev{color:#aaa!important;background:#e9e9e9!important;border:1px solid #e9e9e9!important;text-shadow:none!important}
...
.webix_el_combo input,.webix_el_datepicker input,.webix_el_search input,.webix_el_text input{height:100%;padding:0 10px;border:1px solid transparent;color:#555;font-size:15px;background:#fff;font-family:Tahoma;border-color:#bcbcbc!important;-webkit-appearance:none;border-radius:0;padding-top:4px\0}
...
.webix_inp_counter_value{font-size:15px;width:50px;color:#555;text-align:center;border-left-width:0;border-right-width:0;padding-top:4px\0;-webkit-appearance:none;border-radius:0}
.webix_inp_counter_next,.webix_inp_counter_prev{padding-left:6px;font-size:15px;font-family:Tahoma;border:1px solid #bcbcbc;border-bottom:1px solid #b2b2b2;color:#fff;background:#bcbcbc;-webkit-border-radius:0;-moz-border-radius-topleft:0;-moz-border-radius-bottomleft:0;-moz-border-radius-topright:0;-moz-border-radius-bottomright:0;border-radius:0}
.webix_el_textarea textarea{border:1px solid transparent;height:100%;margin:0;padding:5px 10px;color:#555;resize:none;font-size:15px}
.webix_el_textarea .webix_inp_label{padding-top:7.5px}
.webix_segment_0,.webix_segment_1{height:100%}
.webix_segment_0{-webkit-border-radius:0;-moz-border-radius-topleft:0;-moz-border-radius-bottomleft:0;-moz-border-radius-topright:0;-moz-border-radius-bottomright:0;border-radius:0}
.webix_segment_N{height:100%;-webkit-border-radius:0;-moz-border-radius-topleft:0;-moz-border-radius-bottomleft:0;-moz-border-radius-topright:0;-moz-border-radius-bottomright:0;border-radius:0}
...
.webix_line_break{clear:both;height:4.5px}
.webix_radio_option{display:table;float:left;margin-top:4.5px;margin-right:20px}
...
.webix_el_colorpicker .webix_inp_static div{float:right;width:20px;height:20px;margin:2px -16px 0 -5px;border-radius:0}
...
.webix_multicombo_value{padding:0 5px 0 7px;background-color:#e7e7e7;display:inline-block;margin:3px;float:left;-webkit-border-radius:0;-moz-border-radius:0;border-radius:0}
...
.webix_item_tab{display:table-cell;text-align:center;vertical-align:middle;overflow:hidden;cursor:pointer;border:1px solid transparent;border-left-width:0;background:#bcbcbc;-webkit-border-radius:0;-moz-border-radius-topleft:0;-moz-border-radius-bottomleft:0;-moz-border-radius-topright:0;-moz-border-radius-bottomright:0;border-radius:0;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}
...
.webix_menu-x .webix_list_item:active,.webix_menu-x .webix_list_item:hover{background-color:#c4c4c4}
...
.webix_slider_box .webix_slider_left{height:10px;float:left;width:100px;-webkit-border-radius:5px 0 0 5px;-moz-border-radius-topleft:5px;-moz-border-radius-bottomleft:5px;-moz-border-radius-topright:0;-moz-border-radius-bottomright:0;border-radius:5px 0 0 5px;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}
.webix_slider_box .webix_slider_right{height:10px;float:left;width:100px;background:#fff;-webkit-border-radius:0 5px 5px 0;-moz-border-radius-topleft:0;-moz-border-radius-bottomleft:0;-moz-border-radius-topright:5px;-moz-border-radius-bottomright:5px;border-radius:0 5px 5px 0;border:1px solid rgba(13,13,13,0);-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}
.webix_slider_box .webix_slider_handle{z-index:1px;position:absolute;top:7px;border-radius:8px}
...
.webix_slider_box .webix_slider_handle{width:17px;height:17px;background:#e42750}
...
.webix_slider_alt .webix_slider_box .webix_slider_handle{background-color:#e2e2e2;border:1px solid #c1c1c1}
